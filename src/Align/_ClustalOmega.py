...
class ClustalOmegaCommandline(AbstractCommandline):
    ...
    ----------
    cmd : str, optional
        The command to use. Defaults to "clustalo".
    infile : str, optional
        Multiple sequence input file.
    hmm_input : str, optional
        HMM input files.
    dealign : bool, optional
