...
class ClustalwCommandline(AbstractCommandline):
    ...
    ----------
    cmd : str, optional
        The command to use. Defaults to "clustalw".
    infile : str, optional
        Input sequences.
    profile1 : str, optional
        Profiles (old alignment).
    profile2 : str, optional
        Profiles (old alignment).
