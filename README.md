...
2. Adjust `DATA_DIR` variable in the [`config.py` file](https://github.com/bschilder/VEP_protein/blob/main/src/config.py) to the on-disk location where you'd like to store files.  

3. Follow the [VEP tutorial notebook](https://github.com/bschilder/VEP_protein/blob/main/notebooks/VEP.ipynb).